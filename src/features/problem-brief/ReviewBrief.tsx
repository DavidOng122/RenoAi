...
export function ReviewBrief() {
  ...
  return <div className="brief-shell">
    ...
    {!editing && <div className="actions"><button className="secondary-btn" onClick={() => setEditing(true)}><Pencil size={16}/> Edit</button><button className="primary-btn analyse-btn" onClick={confirm}>Confirm & analyse <ArrowRight size={17}/></button></div>}
    <MobileBottomNav/>
  </div>;
}
